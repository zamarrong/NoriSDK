...
namespace NoriSDK
{
    ...
    public class Departamento
    {
        ...
        public static Table<Departamento> Departamentos()
        {
            return Nori.CrearContexto().GetTable<Departamento>();
        }
        ...
        public static Departamento Obtener(int id)
        {
            try
            {
                return Departamentos().Where(x => x.id == id).First();
            }
            catch (Exception ex)
            {
        ...
        public bool Actualizar()
        {
            try
            {
                ...
                var Tabla = Departamentos();
                Departamento departamento = Tabla.Where(x => x.id == id).First();
                this.CopyProperties(departamento);
                Tabla.Context.SubmitChanges();
                return true;
            }
            catch (Exception ex)
